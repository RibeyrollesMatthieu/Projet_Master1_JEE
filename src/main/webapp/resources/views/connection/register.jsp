    ...
    <div class="text-center w-3/4 m-auto">
      ...
      <div id="content" class="flex flex-wrap content-center justify-between items-center mt-9 space-x-3">
        ...
        <form id="register-form" class="flex-1 rounded shadow shadow-white p-5 bg-gray-200 dark:bg-gray-700 text-black"
          ...
          <div class="mb-4"> <t:input id="firstname" type="text" placeholder="Firstname" autofocus='true' length="${sessionScope.columnsLength.get('firstname')}"/> </div>
          <div class="mb-4"> <t:input id="lastname" type="text" placeholder="Lastname" length="${sessionScope.columnsLength.get('lastname')}"/> </div>
          <div class="mb-4"> <t:input id="password" type="password" placeholder="Password" length="${sessionScope.columnsLength.get('password')}"/> </div>
          <div class="mb-4"> <t:input id="confirm-password" type="password" placeholder="Confirm password" length="${sessionScope.columnsLength.get('password')}"/> </div>
          <div class="mb-4"> <t:input id="email" type="email" placeholder="Email address" length="${sessionScope.columnsLength.get('email')}"/> </div>
          <div class="mb-4"> <t:input id="date" type="text" placeholder="Birthdate" length="${sessionScope.columnsLength.get('birthdate')}"/> </div>
